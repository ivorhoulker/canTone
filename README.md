...
<video src="https://github.com/ivorhoulker/canTone/raw/refs/heads/main/assets/cantone-search.webm" autoplay loop muted playsinline width="100%"></video>
...
* **離線優先：** 完整的資料庫與搜尋引擎完全在您的本機電腦上離線運行。

---

## 🐛 錯誤回報與功能建議

遇到錯誤或有新功能建議嗎？我使用此存放庫來追蹤社群的意見回饋。
...
本應用程式屬專有軟體（Proprietary software）。保留所有權利。
您可以下載並將本軟體用於個人用途。
...
* **[Unicode 與 Unihan](https://www.unicode.org/charts/unihan.html)**: Copyright © 1991-Present Unicode, Inc. 根據 [Unicode 版權使用條款 (Unicode Copyright Terms of Use)](https://www.unicode.org/copyright.html) 及 [Unicode 資料授權條款 (Unicode Data License)](https://www.unicode.org/license.txt) 分發。
